...
plot_marginal_fit(sample_v, dist0, fig=fig, ax=ax1, label='$h_s$ (m)',
...
iform_contour_1 = IFormContour(fit.mul_var_dist, return_period_1, ts, 200)
return_period_50 = 50
iform_contour_50 = IFormContour(fit.mul_var_dist, return_period_50, ts, 200)


contour_v_1 = iform_contour_1.coordinates[0][0]
contour_hs_1 = iform_contour_1.coordinates[0][1]
contour_v_50 = iform_contour_50.coordinates[0][0]
contour_hs_50 = iform_contour_50.coordinates[0][1]

# Save the contours as csv files in the required format.
folder_name = 'contour-coordinates/'
file_name_1 = determine_file_name_e1('Andreas', 'IFORM_Haselsteiner', DATASET_CHAR, return_period_1)
write_contour(contour_v_1,
              contour_hs_1,
              folder_name + file_name_1,
              label_x=label_v,
              label_y=label_hs)
file_name_20 = determine_file_name_e1('Andreas', 'IFORM_Haselsteiner', DATASET_CHAR, return_period_50)
